...
export class Selection extends React.Component {
  ...
  _calculateSelectionBox(startPoint, endPoint) {
    ...
    const left = Math.min(startPoint.x, endPoint.x)
      - rect.left
      - this.refs.selectionBox.scrollLeft
      - scrollLeft

    const top = Math.min(startPoint.y, endPoint.y)
      - rect.top
      + this.refs.selectionBox.offsetTop
      - scrollTop
  ...
  render() {
    ...
    if (this.state.mouseDown && !_.isNull(this.state.endPoint)
      ...
      selectionBox = <div className="selection-border" style={this.state.selectionBox}></div>
    }
    ...
    return (
      <div ref="selectionBox" onMouseDown={this._onMouseDown}>
        {children}
        {selectionBox}
      </div>
    )
